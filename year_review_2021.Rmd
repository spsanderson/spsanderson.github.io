...
data_tbl %>%
  ...
  distinct() %>%
  set_names("Package", "Number of Releasees") %>%
  kable()
```

So all in all there was a total of `r nrow(data_tbl) %>% scales::number(big.mark=",")` downloads of all the `healthyverse` packages in 2021.
