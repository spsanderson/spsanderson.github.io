...
#
> __2023__ A Year in Review

The year 2023 was a big year for me. I did a lot of coding, a lot more than I 
...
In order to start looking at some of the data that pertains to 2023 lets first
...
Ok now that we have our data, lets ensure that we are only using the year 2023.
...
Now that we have our data, we have it for the year 2023 only with a start date
...
countries that downloaded `healthyverse` packages in 2023.
